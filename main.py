...
# These pure helpers now live in the extracted mixins, but the test-suite imports
# them from ``main`` by convention, so re-export them here.
from chimera_core import (  # noqa: F401
    math_2_latex,
    parser,
    process_params,
    read_file,
...
class MainWindow(OnlineUIMixin, ProjectIOMixin, PlottingMixin, tk.Frame):
